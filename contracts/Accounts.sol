...
contract Accounts {
    ...
    function setAccount(address _addr,
    bytes16 _firstName,
    bytes16 _lastName,
    ...
    function getAccount(address _addr) public view returns
    (bytes16, bytes16, uint[] memory, uint[] memory, address,string memory,string memory) {
        return (accounts[_addr].firstName,
    ...
    function getEmployerJobs(address _addr) public view returns (uint[] memory) {
    ...
    function getWorkerJobs(address _addr) public view returns (uint[] memory) {
    ...
    function countAccounts() public view returns (uint) {
